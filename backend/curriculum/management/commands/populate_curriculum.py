...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        dp_project3 = Project.objects.create(
            ...
            tech_stack=['Google BigQuery/AWS Redshift', 'PostgreSQL', 'Python', 'Advanced SQL', 'Apache Superset', 'Cloud SDK'],
            estimated_hours=60,
            order=3
        )
        ...
        fsd_project3_django = Project.objects.create(
            ...
            description='Build and deploy a real-time social platform with CI/CD on AWS/GCP',
            project_type='CAPSTONE',
            tech_stack=['React', 'Django Channels', 'PostgreSQL', 'Redis', 'Docker', 'Terraform', 'GitHub Actions', 'AWS EC2/RDS'],
            estimated_hours=70,
            order=3
        )
        ...
        ProjectStep.objects.bulk_create([
            ...
            ProjectStep(project=fsd_project3_django, step_number=4, title='Write Terraform scripts → provision AWS EC2 + RDS', 
            ...
            ProjectStep(project=fsd_project3_django, step_number=6, title='Deploy live to AWS free tier (public URL)', 
                       description='Complete deployment and configure DNS', estimated_minutes=180, order=6),
        ])
        
        # FSD Project 3 Django Deliverables
        Deliverable.objects.bulk_create([
            Deliverable(project=fsd_project3_django, title='Cloud-deployed app URL (AWS/GCP)', 
                       deliverable_type='LINK', is_required=True, order=1),
